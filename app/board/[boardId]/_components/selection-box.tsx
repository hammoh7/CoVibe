...
import { Dimensions, LayerType, Side } from "@/types/canvas";
import { memo } from "react";

interface SelectionBoxProps {
  onResizeHandlePointerDown: (corner: Side, initialBounds: Dimensions) => void;
}
...
export const SelectionBox = memo(
  ({ onResizeHandlePointerDown }: SelectionBoxProps) => {
    ...
    return (
      <>
        <rect
          className="fill-transparent stroke-red-400 stroke-1 pointer-events-none"
        ...
        {isShowingHandles && (
          <>
            <rect
              className="fill-white stroke-1 stroke-red-400"
              x={0}
              y={0}
              style={{
                cursor: "nwse-resize",
